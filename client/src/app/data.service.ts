...
export class DataService {
  ...
  createUser(data) {
    ...
    return this.http.post(
      'https://knoxpo-pa19-js.onrender.com/api/v1/create',
      data
    );
  }
  ...
  getAllUser() {
    ...
    return this.http.get('https://knoxpo-pa19-js.onrender.com/api/v1/getAll');
  }

  deleteUser(id) {
    return this.http.delete(
      `https://knoxpo-pa19-js.onrender.com/api/v1/delete/${id}`
    );
  ...
  getUserById(id) {
    return this.http.get(
      `https://knoxpo-pa19-js.onrender.com/api/v1/get/${id}`
    );
  ...
  updateUser(data, id) {
    return this.http.put(
      `https://knoxpo-pa19-js.onrender.com/api/v1/update/${id}`,
      data
    );
  ...
  postWeather(data) {
    return this.http.post(
      'https://knoxpo-pa19-js.onrender.com/api/v1/weather',
      data
    );
